...
import './styles.css'; //  все модули-js , даже css - module  поэтому все должно import в наше дерево
...
const fetchedPhotos = [];  // все фото за текущую ссесию - Будем хранить все что пользовалель искаол
...
function handleFetch(params) {
  ...
  fetchImages(params).then(photos => {
    ...
    storage.set(fetchedPhotos); // список поиска USER добавили в LS
